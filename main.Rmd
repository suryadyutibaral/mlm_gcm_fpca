...
Ly_ht <- lapply(seq_len(ncol(growth$hgtf)), function(i) growth$hgtf[,i])
Lt_ht <- lapply(seq_len(ncol(growth$hgtf)), function(i) (growth$age - min(growth$age))/(max(growth$age - min(growth$age))))
